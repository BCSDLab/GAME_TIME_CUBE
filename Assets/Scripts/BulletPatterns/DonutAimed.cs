...
public class DonutAimed : AimedBulletPattern
{
    ...
    protected override IEnumerator Fire()
    {
        ...
        while (true)
        {
            ...
            m_dx = transform.position.x - m_targetPos.x;
            m_dy = transform.position.y - m_targetPos.y;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                bulletInst.transform.position = transform.position + new Vector3(radius * Mathf.Cos(twoPiPerCount * i), radius * Mathf.Sin(twoPiPerCount * i), 0f);
