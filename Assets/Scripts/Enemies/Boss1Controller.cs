...
public class Boss1Controller : Enemy
{
    ...
    protected override void Start()
    {
        ...
        m_vertical = GetComponent<Vertical>();
    ...
    private IEnumerator Blow()
    {
        ...
        yield return new WaitForSeconds(particleSystems[0].main.duration + 0.1f);
